...
const STRINGS = {
  ...
  "editor.undo": ["撤销", "Undo"],
  "editor.redo": ["重做", "Redo"],
  "editor.image.width": ["图片宽度", "Image width"],
  "editor.image.drag": ["拖动调整大小", "Drag to resize"],
  "editor.image.reset": ["原宽", "Reset size"],
  "editor.image.alignLeft": ["图片靠左", "Align left"],
  "editor.image.alignCenter": ["图片居中", "Align center"],
  "editor.image.alignRight": ["图片靠右", "Align right"],
  "editor.image.remove": ["删除图片", "Remove image"],
  "editor.table": ["表格", "Table"],
  "editor.table.insert": ["插入表格", "Insert table"],
  "editor.table.rowLabel": ["行", "Row"],
  "editor.table.colLabel": ["列", "Col"],
  "editor.table.rowBefore": ["上方插入一行", "Insert row above"],
  "editor.table.rowAfter": ["下方插入一行", "Insert row below"],
  "editor.table.colBefore": ["左侧插入一列", "Insert column left"],
  "editor.table.colAfter": ["右侧插入一列", "Insert column right"],
  "editor.table.deleteRow": ["删除这一行", "Delete row"],
  "editor.table.deleteCol": ["删除这一列", "Delete column"],
  "editor.table.delete": ["删除整个表格", "Delete table"],
