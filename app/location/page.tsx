...
export default function LocationPage() {
  return (
    <div className="max-w-5xl mx-auto px-6 py-16">
      <h1 className="text-3xl font-semibold text-bark mb-2">
        Location &amp; Contact
      </h1>
      ...
      <div className="grid sm:grid-cols-2 gap-12">
        ...
        <div className="space-y-6">
          <div className="bg-white border border-brand-light rounded-xl p-6 shadow-sm">
            <h2 className="font-semibold text-bark mb-4 text-lg">
              Jane&apos;s Therapy
            </h2>
            ...
            <div className="space-y-4 text-sm text-bark-light">
              <div>
                ...
                <p className="mt-1">
                  ...
                  <br />
                  <strong>
                    Please contact Jane directly for the address.
                  </strong>
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-xs mt-1 text-bark-light/70">
                  I do not have front desk staff. Please text me and I&apos;ll
